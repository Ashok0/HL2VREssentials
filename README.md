...
- Fixed the Nightmare House and MINERVA menus.
...
1. Download [**HLVR_MO2_Repack_v1.02.rar**](http://188.42.46.42/hl2vr/HLVR_MO2_Repack_v1.02.rar) and extract Mod Organizer 2 to a folder of your choice outside of "Users" or "Program Files".  It's best to extract the folder near the root level of your drive i.e. C:\Games\HL2VR
...
3. Navigate to where you extracted HLVR_MO2_Repack_v1.02.rar and run ModOrganizer.exe
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;» Enable the Alyx style zombie mods under "Optional Texture Mods" to enable HD zombies and headcrabs.  Disabled by default as these mods change the artsyle from the original vanilla models.
